...
class filter_sched(SimpleFilterSched):
    """
...
class Sky_area_generator_galplane(SkyAreaGenerator):
...
def ddf_surveys(detailers=None, season_frac=0.2, euclidDetailers=None):
    ...
    survey2 = ScriptedSurvey([], detailers=euclidDetailers)
...
if __name__ == "__main__":
    ...
    uDetailer = detailers.FilterNexp(filtername='u', nexp=1)
    ditherDetailer = detailers.DitherDetailer(per_night=per_night, max_dither=max_dither)
    details = [detailers.CameraRotDetailer(min_rot=-camera_ddf_rot_limit, max_rot=camera_ddf_rot_limit),
               ditherDetailer, uDetailer, detailers.Rottep2RotspDesiredDetailer()]
    euclidDetailers = [detailers.CameraRotDetailer(min_rot=-camera_ddf_rot_limit, max_rot=camera_ddf_rot_limit),
                        detailers.EuclidDitherDetailer(), uDetailer, detailers.Rottep2RotspDesiredDetailer()]
    ddfs = ddf_surveys(detailers=details, season_frac=ddf_season_frac, euclidDetailers=euclidDetailers)
