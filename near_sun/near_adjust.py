...
def main(args):
    ...
    filter_dist_weight = args.filter_dist_weight
    sun_alt_limit = args.sal
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + "_"
    file_end = "fdw_%.2f_sal_%.1f_" % (filter_dist_weight, np.abs(sun_alt_limit)) + "v3.2_"
    ...
    neo = generate_twilight_near_sun(
        ...
        filter_dist_weight=filter_dist_weight,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filter_dist_weight", type=float, default=3.0)
    parser.add_argument("--sal", type=float, default=-14.8)
