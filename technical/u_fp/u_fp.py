...
class UareaFootprint(EuclidOverlapFootprint):
    def return_maps(
        self,
        u_override=0.4,
        lmc_ra=89.0,
        ...
        magellenic_clouds_ratios["u"] = u_override
        low_dust_ratios["u"] = u_override
        euclid_ratios["u"] = u_override
        virgo_ratios["u"] = u_override
...
def main(args):
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + "_"
    file_end = "uo%.2f_v3.2_" % u_override
    ...
    sky = UareaFootprint(nside=nside, smc_radius=4, lmc_radius=6)
    footprints_hp_array, labels = sky.return_maps(u_override=u_override)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--u_override", type=float, default=0.4)
